...
%% Uncertain Obstacle 2: Eq(5)
syms x1 x2 w t
% probabilistic obstacle
px=0.4+w+t; % uncertain trajectory px
g=0.3^2-(x1-px)^2-(x2-1)^2; % obstacle g(x1,x2,w1)>=0
...
Delta=0.1;
[x1,x2]=meshgrid([-0.2:0.01:2.5],[-0.5:0.01:1.5]);
figure; hold on
...
t=[0:0.01:1];px=0.4+t;py=1*ones(size(t,2));plot(px,py,'k--','Linewidth',3)
end
